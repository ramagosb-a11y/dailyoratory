...
const slots = [
  ...companion.meditationParts.flatMap(p => p.scriptureReferences.map((reference, index) => ({ slot: `meditation:${p.id}:${index}`, reference }))),
...
const books = { Matthew: 'MAT', Mark: 'MRK', Luke: 'LUK', John: 'JHN', '1 Timothy': '1TI', Philippians: 'PHP', Romans: 'ROM', '1 Thessalonians': '1TH', Psalm: 'PSA', '1 Corinthians': '1CO', Exodus: 'EXO', Revelation: 'REV', '1 Kings': '1KI', Isaiah: 'ISA', Ezekiel: 'EZK', Galatians: 'GAL', Joshua: 'JOS' };
