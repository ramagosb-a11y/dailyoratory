...
export const metadata: Metadata = createPageMetadata({
  title: "Prayer and Sacramental Life Examination",
  description: "Review confession preparation prompts for prayer, Mass, confession, Scripture, reverence, and trust. Notes stay local only.",
  path: "/confession/examination/prayer-sacramental-life",
});

export default function PrayerSacramentalLifeExaminationPage() {
  const path = getGuidedExaminationPath("prayer-sacramental-life");
  if (!path) return null;
