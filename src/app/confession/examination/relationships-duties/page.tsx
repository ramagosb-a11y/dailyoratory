...
export const metadata: Metadata = createPageMetadata({
  title: "Relationships and Duties Examination",
  description: "Review confession preparation prompts for charity, truth, duties, promises, and reconciliation. Notes stay local only.",
  path: "/confession/examination/relationships-duties",
});

export default function RelationshipsDutiesExaminationPage() {
  const path = getGuidedExaminationPath("relationships-duties");
  if (!path) return null;
