...
export const metadata: Metadata = createPageMetadata({
  title: "State of Life Examination",
  description: "Review confession preparation prompts for state of life, duties, prayer, sacraments, and works of mercy. Notes stay local only.",
  path: "/confession/examination/state-of-life",
});

export default function StateOfLifeExaminationPage() {
  const path = getGuidedExaminationPath("state-of-life");
  if (!path) return null;
