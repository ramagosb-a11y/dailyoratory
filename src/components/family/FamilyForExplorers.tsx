    ...
    <section>
      ...
      <div className="card-parchment mt-7 p-6">
        ...
        <div className="mt-6 grid gap-3 sm:grid-cols-2 xl:grid-cols-3">
          <Link prefetch={false} href="/ocia" className="btn liturgical-button focus-ring justify-center">
            Explore OCIA
          </Link>
          <Link prefetch={false} href="/mass" className="btn btn-secondary focus-ring justify-center">
            Attend the Mass
          </Link>
          <Link prefetch={false} href="/sacraments" className="btn btn-secondary focus-ring justify-center">
            Learn the Sacraments
          </Link>
          <Link prefetch={false} href="/pray" className="btn btn-secondary focus-ring justify-center">
            Begin Prayer
          </Link>
          <Link prefetch={false} href="/catechism" className="btn btn-secondary focus-ring justify-center">
            Read the Catechism
          </Link>
