import type { LiturgyHoursResource } from "@/types/liturgyOfTheHours";

export function LiturgyHoursTrustedSources({ resources }: { resources: LiturgyHoursResource[] }) {
  return (
    <section>
      <div>
        ...
        {resources.map((resource) => (
          <article key={resource.id} className="card p-5">
            <div className="flex flex-wrap items-center justify-between gap-2">
              ...
              {resource.official ? <span className="season-pill">Official Church source</span> : null}
            </div>
