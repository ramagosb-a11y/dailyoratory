...
export const growInFaithSection: HomepageSection = {
  ...
  cards: [
    {
      id: "faith-bible",
      title: "The Bible and Sacred Scripture",
      description:
        "Learn how Catholics read the Bible, pray with the Word of God, choose Catholic translations, and understand Scripture with Tradition and the Church.",
      href: "/bible",
    ...
    },
    {
      ...
      description:
        "Understand how Scripture, Sacred Tradition, and the Magisterium work together as the Catholic faith is handed on through the Holy Spirit.",
      href: "/tradition",
      cta: "Explore Sacred Tradition",
      category: "Learn",
      sortOrder: 20,
    },
    {
      id: "faith-church-fathers",
      title: "Church Fathers",
      description:
        "Meet the early Christian witnesses who taught Scripture, sacraments, prayer, doctrine, and holiness.",
      href: "/church-fathers",
      cta: "Meet the Church Fathers",
      category: "Learn",
      sortOrder: 30,
    },
    {
      ...
      description:
        "Learn what the Catholic Church teaches, how the Catechism is organized, and how to use it for prayer, study, formation, and daily discipleship.",
      href: "/catechism",
