...
R. Receive them, Lord.`,
  ...
  },
  {
    ...
    category: "Family",
    needTags: ["I want to pray for my family.", "I need holiness."],
    summary: "A prayer asking God to teach a husband sacrificial, attentive, holy love for his wife.",
    href: "/prayers/prayer-for-wife",
    relatedLinks: [
      { label: "Prayer Library", href: "/prayers" },
      { label: "Marriage", href: "/sacraments/marriage" },
      { label: "Catholic Life", href: "/catholic-life" },
    ],
    alternateTitles: ["Intentional Prayer for Loving My Wife", "Prayer for Wife"],
    searchKeywords: ["prayer for my wife", "husband prayer", "marriage prayer", "Catholic prayer for wife", "Ephesians 5:25", "Proverbs 12:4"],
  },
  {
...
export const prayerNeedCards: PrayerNeedCard[] = [
  ...
  },
  {
    ...
    prayerIds: ["prayer-for-my-family", "prayer-for-wife", "prayer-for-children", "prayer-for-peace-in-the-home"],
  },
  {
    id: "someone-sick",
